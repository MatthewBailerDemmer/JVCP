...
public class StringCompare {
    public static void main(String[] args){
        ...
        System.out.printf(
                "s1 = %s%ns2 = %s%ns3 = %s%ns3 = %s%n%n", s1, s2, s3, s4
        );
        ...
        System.out.printf(
                "%ns4.compareTo(s4) is %d%n", s4.compareTo(s3));
        ...
        if(s3.regionMatches(true,0, s4, 0, 5))
            System.out.println("First 5 characters of s3 and s4 match with ignore case");
        else
            System.out.println("First 5 characters of s3 and s4 do not match witch ignore case");
